...
2. **Retrieve memory** — invoke `Memory-Agent` in **RETRIEVE mode** with domain `search-engine` and a one-line description of the current task. Apply any retrieved insights before proceeding.
