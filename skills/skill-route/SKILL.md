...
| **token-budget**      | `c:\Users\giladme\.copilot\skills\token-budget\SKILL.md`      | Response formatting rules: bullet points, diffs, no intros/summaries. **Mandatory for all agents.**                           | ALL agents                                         |
| **task-scope-guard**  | `c:\Users\giladme\.copilot\skills\task-scope-guard\SKILL.md`  | Scope discipline: only change what was asked, no "while I'm here" additions, escalation protocol.                             | ALL coding agents                                  |
